...
function renderHome(el){
  ...
  const __goSummaryQR2 = $("#goSummaryQR2");
  if(__goSummaryQR2) __goSummaryQR2.onclick = () => location.hash = "#/summary-qr";
}
