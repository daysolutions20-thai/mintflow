...
function renderHome(el){
  ...
  const _goSummaryQR2 = $("#goSummaryQR2"); if(_goSummaryQR2) _goSummaryQR2.onclick = () => location.hash = "#/summary-qr";
}
